...
export default function ImagenesReferencia({ img1, img2, img3, img4 }) {
    const [mainImage, setMainImage] = useState(`http://localhost:3000/uploads/${img1}`);
    ...
    return (
        <div className="box-container-img">
            ...
            <div className="box-container-childs">
                <div className="son" onClick={() => handleImageClick(`http://localhost:3000/uploads/${img1}`)}>
                    <img src={`http://localhost:3000/uploads/${img1}`} alt="Imagen 1" />
                </div>
                <div className="son" onClick={() => handleImageClick(`http://localhost:3000/uploads/${img2}`)}>
                    <img src={`http://localhost:3000/uploads/${img2}`} alt="Imagen 2" />
                </div>
                <div className="son" onClick={() => handleImageClick(`http://localhost:3000/uploads/${img3}`)}>
